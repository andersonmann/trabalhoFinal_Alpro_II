...
public class App {
	...
	public static void main(String[] args) throws IOException, EstadioException {
		...
		// Exibe os socios que estão no arquivo
		...
		System.out.println("Média das modalidades de socios: " + catraca.mediaSocios());
		System.out.println("");
		System.out.println("Média de socios que entraram da modalidade \"Comum\": " + catraca.mediaSociosQueEntraramModalidadeComuns());
		System.out.println("");
		System.out.println("Média de socios que entraram da modalidade \"estudante\": "	+ catraca.mediaSociosQueEntraramModalidadeEstudantes());
		System.out.println("");
		System.out.println("Média de socios que entraram da modalidade \"idoso\": " + catraca.mediaSociosQueEntraramModalidadeIdosos());
		System.out.println("");
		// Retorna o total de operações de acesso (contador)
		System.out.println("Total de operações de acesso: " + catraca.getContador());
