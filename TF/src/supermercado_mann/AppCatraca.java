...
public class AppCatraca {
	...
	public static void main(String[] args) throws IOException, EstadioException {
		...
		/*
		 * QueueLinked<Jogo> lista = new QueueLinked<>(); Socio s1 = new
		 * Socio("Anderson", "1010", Categoria.NADA_VAI_NOS_SEPARAR); Socio s2 =
		 * new Socio("Eduardo", "2020", Categoria.CAMPEAO_DO_MUNDO);
		 * //QueueLinked<Jogo> lista = new QueueLinked<Jogo>(); Jogo j1 = new
		 * Jogo(100000, "17/06/2014", "Beira Rio", "França", "Honduras", 150);
		 * 
		 * lista.add(j1); System.out.println(""+lista.toString());
